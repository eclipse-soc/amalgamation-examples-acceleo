 ...
 *******************************************************************************/
package org.acceleo.example.droid.main;
...
public class Main extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/acceleo/example/droid/main/main";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(droid.DroidPackage.class)) {
            resourceSet.getPackageRegistry().put(droid.DroidPackage.eINSTANCE.getNsURI(), droid.DroidPackage.eINSTANCE);
        }
